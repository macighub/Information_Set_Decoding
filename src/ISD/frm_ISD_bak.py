...
class ISDApp(tk.Tk):
    ...
    def __init__(self):
        ...
        self.pnl_progress_data.rowconfigure(1, weight=0)  # Bottom notebook fixed height
        ...
        self.top_frame.columnconfigure(0, weight=1)   # tab_H fills available width
        self.top_frame.columnconfigure(1, weight=0)   # tab_y fixed width
        ...
        match option:
            ...
            case "generate":
                try:
                    ...
                    self.after(0, lambda: messagebox.showerror("Input Error",
                                         "Values of 'n', 'k', and 't' must be non-empty integer values."))
            case _:
                self.after(0, self.hide_progress)
                return
